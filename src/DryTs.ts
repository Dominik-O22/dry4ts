...
export const USAGE = [
  ...
  "                  min-nodes 40). agent: pr preset + counterparts + json, for",
  "                  after-edit agent loops (needs --changed-from/--changed).",
  ...
  "                  default off; off-path output is byte-identical. (prototype)",
